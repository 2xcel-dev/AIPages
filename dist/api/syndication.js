...
export const FEED_DESCRIPTION = "Real-time syndication feed of machine-readable tools, schemas, endpoints, and health statuses for autonomous AI agents.";
/**
 * Format a Tool record into a standard JSON Feed item with _aipages machine extensions.
 */
export function formatFeedItem(tool, baseUrl = FEED_HOME_PAGE) {
 ...
 */
export function buildSyndicationFeed(tools, options) {
    ...
    return {
        ...
        feed_url: feedUrl,
        description,
        user_comment: "This feed provides live syndicated tool records from the AIPages registry. Updated continuously on crawler cycles.",
 ...
 */
export async function handleSyndicationFeed(c, store) {
 ...
 */
export function createSyndicationRouter(getStore) {
