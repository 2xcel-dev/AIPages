 ...
 */
export async function generateToolSchema(toolName, description) {
    ...
    const systemInstruction = `You are a tool schema generator. Given a tool name and description, ` +
...
- "confidence": a number 0-1 representing your confidence`;
    ...
    const responseSchema = {
        ...
        properties: {
            schema: {
                type: Type.STRING,
                description: "A JSON Schema (Draft-07) string describing the tool's input parameters",
            },
            confidence: {
                type: Type.NUMBER,
 ...
 */
export function generatedSchemaUrl(namespace) {
