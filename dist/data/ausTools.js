...
export const AUS_AUTH_SPEC = "x402 payment protocol (Header: x-payment-receipt; Token: USDC on Base Mainnet; Recipient: 0xE57cB8C73c4000EA04ba0eb607228CbAec7f8e9C)";
export const AUS_PROTOCOL_DETAILS = "HTTP POST, 2MB JSON body limit, express-rate-limit, in-memory anti-replay receipt caching";
export const CANONICAL_AUS_TOOLS = [
    {
        namespace: "net.2xcel.aus.schema-sanitizer",
        name: "schema_sanitizer",
        description: "Agent Utility Service (AUS) Schema Sanitizer: Enterprise-grade input sanitization, XSS/HTML tag stripping, key normalization, and sensitive field masking for structured JSON data.",
        schema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Agent Utility Service (AUS) Financial Audit: Batch transaction ledger reconciliation, volume computation, risk scoring, and anomaly detection for autonomous agent cashflows.",
        schema: {
            type: "object",
            properties: {
                transactions: {
    ...
    },
    {
        ...
        description: "Agent Utility Service (AUS) Verification Oracle: Deterministic SHA-256 state attestation, integrity hashing, and cryptographic signature/hash matching.",
        schema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Agent Utility Service (AUS) Geospatial Verifier: Haversine distance calculation, geofencing boundary verification, and coordinates proximity validation.",
        schema: {
            type: "object",
            properties: {
                origin: {
    ...
    },
    {
        ...
        description: "Agent Utility Service (AUS) Sandbox Execution: Secure, isolated Node.js vm execution sandbox with configurable execution timeouts, strict context isolation, and CPU protection.",
        schema: {
            type: "object",
            properties: {
                code: {
    ...
    },
    {
        ...
        name: "claude_reason",
        description: "Agent Utility Service (AUS) Claude Reason Engine: Deep analytical reasoning, chain-of-thought verification, and multi-step inference powered by Claude Opus 5.",
        schema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Agent Utility Service (AUS) Media Transcoder: MIME format analysis, byte size verification, payload hashing, and base64/URI media inspection.",
        schema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        name: "agentic_audit",
        description: "Agent Utility Service (AUS) Agentic Audit: Autonomous agent workflow trace auditing, execution step health scoring, circular action loop detection, and budget limit enforcement.",
        schema: {
            type: "object",
            properties: {
...
//# sourceMappingURL=ausTools.js.map